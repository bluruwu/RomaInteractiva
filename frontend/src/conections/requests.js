export const postData = async (mydata) => {
	try {
		const response = await fetch("https://vercel-back-diu4x3weq-edinsonuwu.vercel.app/register/user", {
			method: "POST",
			headers: {
...
export const postLogin = async (mydata) => {
	try {
		const response = await fetch("https://vercel-back-diu4x3weq-edinsonuwu.vercel.app/login", {
			method: "POST",
			headers: {
				"Content-Type": "application/json",
			},
...
export const postQuiz = async (mydata) => {
	try {
		const response = await fetch("https://vercel-back-diu4x3weq-edinsonuwu.vercel.app/enviarevaluacion", {
			method: "POST",
			headers: {
				"Content-Type": "application/json",
			},
