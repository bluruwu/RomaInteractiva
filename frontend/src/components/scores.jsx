...
export default function Modal() {
    ...
    const getText = (quiz) => {
        if (quiz == 0) {
            ...
            if (quizResuelto) {
                return <span className="flex items-center justify-between px-4"><strong>Monarquía:</strong><span className="text-right">{JSON.parse(localStorage.getItem('aciertosMonarquia'))}/5 aciertos</span></span>
            }
                                    ...
                                    <div className="border rounded-xl flex flex-col items-center justify-center px-6 ">
                                        <div className="w-full bg-white xl:p-0">
                                            ...
                                            <div className="pl-6 pr-6 pb-6 space-y-4 ">
                                                ...
                                                <Button texto={<span className="flex items-center justify-between px-4"><strong>Cultura:</strong><span className="text-right">Sin resolver</span></span>} onClick={() => console.log('jeje')} />
