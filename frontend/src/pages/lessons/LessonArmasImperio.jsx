...
const LessonArmasImperio = () => {
	const paragraphs = [
		`El Imperio Romano era conocido por su poderío militar y su sofisticado armamento, que desempeñó un papel crucial en su expansión y dominio. A lo largo de los siglos, los romanos desarrollaron una amplia variedad de armas y equipos que les permitieron mantener su supremacía en el campo de batalla.`,
		`En primer lugar, la legendaria espada romana, conocida como la gladius, era el arma principal de los soldados romanos. Esta espada de doble filo y hoja corta era ágil y eficiente en el combate cuerpo a cuerpo. La gladius permitía a los romanos realizar rápidos ataques y maniobras en formación, lo que los hacía formidables en el campo de batalla. Además de la espada, los romanos también utilizaban una variedad de lanzas y jabalinas, como la pilum. El pilum era una lanza pesada con una punta afilada y un astil largo. Los soldados romanos arrojaban los pila a sus enemigos antes de cargar, causando estragos en las filas enemigas y desorganizando sus formaciones.`,
	...
	const otrosModelos = [
		{
			description: "Gladius, la espada corta romana",
			titleModel: "Gladius romana",
			source: "https://sketchfab.com/models/45535e01a275448391be7377fb2c0611/embed",
		},
		{
			description: "Pilum, lanza arrojadiza usada al comienzo de la batalla",
			titleModel: "Pilum romana",
			source: "https://sketchfab.com/models/86f390ec545e4529801d2f059cdfd982/embed",
		},
	];
	...
	return (
		<div className="font-text flex flex-col min-h-screen">
			...
			<LessonNav
				...
				mediabef="cristianismo.jpg"
				titlebef="CRISTIANISMO EN EL IMPERIO ROMANO"
				urlnxt="/Final_Imperio"
				medianxt="finalimperio.jpg"
				titlenxt="FINAL DEL IMPERIO ROMANO"
			/>
		</div>
	);
};
