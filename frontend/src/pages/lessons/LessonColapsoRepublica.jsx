	...
	return (
		<div className="font-text flex flex-col min-h-screen">
			...
			<div className="flex flex-grow flex-col md:flex-row relative">
				...
				<LessonText title="Colapso de la República Romana" paragraphs={paragraphs} />
				<LessonModel
					description="Ciudad Roma"
					titleModel="Roma"
					source="https://sketchfab.com/models/0304c6618b984328a6829d474b6e87b4/embed"
				/>
			</div>
			{/* Navegación entre lecciones */}
			<LessonNav
				urlbef="/Expansion_Republica"
				mediabef="expansion.jpg"
				titlebef="EXPANSIÓN DE LA REPÚBLICA ROMANA"
				urlnxt="/Quiz_Republica"
				medianxt="quiz.jpg"
				titlenxt="QUIZ (REPÚBLICA)"
				last={true}
				quiz={"republica"}
			/>
		</div>
