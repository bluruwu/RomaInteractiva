	...
	const paragraphs = [
		`La finalización de la monarquía en la antigua Roma marcó un momento crucial en su historia política y sentó las bases para el desarrollo de la República Romana. 
                Según la tradición, la monarquía romana fue abolida en el año 509 a.C. después de más de dos siglos de gobierno monárquico. El último rey romano, Lucio Tarquinio el Soberbio,
                 fue depuesto debido a su gobierno autoritario y cruel.`, `El colapso de la monarquía fue impulsado por una combinación de factores, incluida la insatisfacción generalizada de los patricios y los plebeyos con el gobierno de Tarquinio 
				 ...
				 más propicio para la instauración de un sistema político republicano.`, ` Tras la caída de la monarquía, Roma experimentó un período de transición hacia la República. 
	...
	return (
		<div className="font-text"> {/* Div principal */}
			...
			<LessonNav urlbef="/Reyes_de_Roma" mediabef="monarquia2.png" titlebef="REYES DE ROMA"
				urlnxt="/Quiz_monarquia_1" medianxt="quiz.jpg" titlenxt="QUIZ (MONARQUIA)" last={true} quiz={'monarquia'}/>
		</div>
	);
};
