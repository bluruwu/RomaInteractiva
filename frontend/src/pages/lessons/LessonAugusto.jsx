...
const LessonAugusto = () => {
	...
	const otrosModelos = [
		{
			description: "Escultura de César Augusto",
			titleModel: "Augusto",
			source: "https://sketchfab.com/models/9d646a47625145cfa59ce2a56482af58/embed",
		},
		{
			description: "Ruinas del Foro de Augusto, construido luego de su consagración",
			titleModel: "Foro de Augusto",
			source: "https://sketchfab.com/models/9f4e01f1ee75439ca53d5cbb982a790a/embed",
		},
	];
	...
	return (
		<div className="font-text flex flex-col min-h-screen">
			...
			<div className="flex flex-grow flex-col md:flex-row relative">
				...
				<LessonText title="Augusto" paragraphs={paragraphs} />
			...
			<LessonNav
				urlbef="/Julio_Cesar"
				mediabef="juliocesar.jpg"
				titlebef="JULIO CÉSAR"
				urlnxt="/Quiz_Personajes"
				medianxt="quiz.jpg"
				titlenxt="QUIZ (PERSONAJES)"
				last={true}
				quiz={"personajes"}
			/>
		</div>
