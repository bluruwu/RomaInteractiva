...
const LessonReyesDeRoma = () => {
	const paragraphs = [
		`Después de la misteriosa desaparición de Rómulo, el fundador de Roma, la ciudad fue gobernada 
                ...
                cultura romana.`,
		`	El segundo rey, después de Rómulo, fue Numa Pompilio, quien se dice que fue elegido 
		...
		`El último de los reyes de Roma fue Tarquinio el Soberbio, un rey etrusco que llegó al poder 
	...
	return (
		<div className="font-text flex flex-col min-h-screen">
			...
			<div className="flex flex-grow flex-col md:flex-row relative">
				...
				<LessonText title="Reyes de Roma" paragraphs={paragraphs} />
				{/* Componente del modelo 3D */}
				<LessonModel
					description="Templo de Vesta, fundado por Numa Pompilio"
					titleModel="Temple of Vesta"
					source="https://sketchfab.com/models/8bdf295b9ff04e3a9fe0f62a0017c120/embed"
				/>
			</div>
			{/* Navegación entre lecciones */}
			<LessonNav
				urlbef="/Fundacion_de_Roma"
				mediabef="fundacionroma.jpg"
				titlebef="FUNDACIÓN DE ROMA"
				urlnxt="/Final_Monarquia"
				medianxt="finalmonarquia.jpg"
				titlenxt="FINALIZACIÓN DE LA MONARQUÍA"
				quiz={"monarquia"}
			/>
		</div>
	);
