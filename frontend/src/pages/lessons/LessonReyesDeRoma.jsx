...
const LessonReyesDeRoma = () => {
    ...
    const paragraphs = [
		`Después de la misteriosa desaparición de Rómulo, el fundador de Roma, la ciudad fue gobernada 
                ...
                cultura romana.`, `	El segundo rey, después de Rómulo, fue Numa Pompilio, quien se dice que fue elegido 
                ...
                la armonía dentro de la ciudad.`, `El último de los reyes de Roma fue Tarquinio el Soberbio, un rey etrusco que llegó al poder 
