...
const LessonFundacionRepublica = () => {
	...
	const otrosModelos = [
		{
			description: "Templo de Neptuno, construido durante la República Romana",
			titleModel: "Templo de Neptuno",
			source: "https://sketchfab.com/models/7a82e48e244445e69fd0a9c7b7c4b256/embed",
		},
		{
			description: "El Foro de Roma, el centro de la República Romana",
			titleModel: "Foro romano",
			source: "https://sketchfab.com/models/8602b8f386b04a9d84e08b76d1fe0a29/embed",
		},
	];
	...
	return (
		<div className="font-text flex flex-col min-h-screen">
			...
			<div className="flex flex-grow flex-col md:flex-row relative">
				...
				<LessonText title="Fundación de la República Romana" paragraphs={paragraphs} />
			...
			<LessonNav
				...
				mediabef="finalmonarquia.jpg"
				titlebef="FINALIZACIÓN DE LA MONARQUÍA"
				urlnxt="/Expansion_Republica"
				medianxt="expansion.jpg"
				titlenxt="EXPANSIÓN DE LA REPÚBLICA ROMANA"
			/>
		</div>
	);
};
