...
const LessonColiseo = () => {
	...
	const otrosModelos = [
		{
			description: "Modelo 3D Coliseo Romano",
			titleModel: "Coliseo Romano",
			source: "https://sketchfab.com/models/544c64b6445e4899a17350c949b7766a/embed",
		},
		{
			description: "Vista del Coliseo junto a parte de Roma Antigua",
			titleModel: "Coliseo y Roma",
			source: "https://sketchfab.com/models/3c5b7197d73342bbb333b24be23ba850/embed",
		},
	];
	...
	return (
		<div className="font-text flex flex-col min-h-screen">
			...
			<div className="flex flex-grow flex-col md:flex-row relative">
				...
				<LessonText title="Coliseo Romano" paragraphs={paragraphs} />
			...
			<LessonNav
				urlbef="/Augusto"
				mediabef="augustus.jpg"
				titlebef="AUGUSTO"
				urlnxt="/Panteon_Agripa"
				medianxt="panteon.jpg"
				titlenxt="PANTEÓN DE AGRIPA"
			/>
		</div>
	);
};
