					...
					if (result.isConfirmed) {
						...
						Swal.fire({
							...
							if ((respuestasCorrectas >= 3) && (result.isConfirmed || result.isDenied)) {//CAMBIAR EL TRUE, POR: respuestasCorrectas == 5
								...
								const updateRes = await updateUserBecauseOfNewAchivement('logro_cultura', token);
								Swal.fire({
									...
									html: `<div class="swal2-content-container">
											  <img src="${gifcultura}" style="display: block; margin: 0 auto; max-width: 100%; max-height: 100%;" />
											  <p style="text-align: left; font-family: 'Merryweather', sans-serif; font-size: 12px; color: #000000; margin-top: 10px;margin-left: 30px;">Logro: My name is Maximus Decimus Meridius</p>
										   </div>`,
									customClass: {
										container: "font-text",
									},
